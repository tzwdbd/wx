...
public interface AccountMapper {
	...
	@Insert("insert into automan.order_account_new(account_type,pay_account, login_pwd,status,create_time,modify_time,device_id,effective_time,account_source) values(#{orderAccount.accountType},#{orderAccount.payAccount}, #{orderAccount.loginPwd}, #{orderAccount.status},now(),now(),0,now(), #{orderAccount.accountSource})")
